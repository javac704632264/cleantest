...
open abstract class BaseFragment: Fragment(), View.OnAttachStateChangeListener {
    protected abstract fun featureId(): String?
    companion object {
...
//    private val listeners = ArrayList<OnFragmentVisibilityChangedListener>()
    ...
    private var listener: OnFragmentVisibilityChangedListener? = null

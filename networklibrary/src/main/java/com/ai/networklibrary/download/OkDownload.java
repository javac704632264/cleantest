...
import com.ai.networklibrary.download.download.DownloadTask;
import com.ai.networklibrary.download.download.DownloadThreadPool;
import com.ai.networklibrary.download.task.XExecutor;
...
public class OkDownload {
    ...
    private OkDownload() {
        ...
        List<Progress> taskList = DownloadManger.getInstance().getDownloading();
        ...
        DownloadManger.getInstance().replace(taskList);
    }

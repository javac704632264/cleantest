...
//        mProgressColor = (int) typedArray.getDimension(R.styleable.CircleProgressView_progressColor, ContextCompat.getColor(getContext(), R.color.purple_200));
...
//        mBackgroundColor = (int) typedArray.getDimension(R.styleable.CircleProgressView_progress_backgroundColor, ContextCompat.getColor(getContext(), R.color.purple_200));
